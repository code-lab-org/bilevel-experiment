...
public class HlaAmbassador extends NullFederateAmbassador implements Ambassador {
	private static Logger logger = LogManager.getLogger(HlaAmbassador.class);
	...
	private void connect(String federationName, String federateName, String federateType) {
