...
public class DesignSpacePainting extends PaintingMethods {
	...
	/* Default constructor. */
	public DesignSpacePainting(Graphics2D g2D_object, String game_file) throws IOException {
...
//		
//		g2D_object.fillRect(DesignSpaceUI.X_RANGE, 0, 1920-DesignSpaceUI.X_RANGE/* width = 610 */, 1080);
